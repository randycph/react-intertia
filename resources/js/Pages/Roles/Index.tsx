...
const RolesIndex = () => {
  const { roles, errors } = usePage<PageProps<{ roles: Role[] }>>().props;
  ...
  const deleteMultiple = () => {
    ...
    router.post("/admin/roles/bulk-delete", { ids });
              ...
              <Dropdown.Menu className="dropdown-menu-end">
                ...
                <li>
                  <Dropdown.Item
                    ...
                    href="#deleteOrder"
                    onClick={() => {
                      setRole(cellProps.row.original);
                      setDeleteModal(true);
                    }}
                  >
                ...
                <Card.Body className="pt-0">
                  {roleData && roleData.length > 0 ? (
                    <TableContainer
                      ...
                      theadClass=""
                      thClass=""
                      handleTicketClick={handleRolesClicks}
                      isTicketsListFilter={false}
                      SearchPlaceholder="Search for role or something..."
                    />
                  ) : (
